...
class MongoFilterBuilderSpec extends Specification{
  ...
  "builds $near" in {
    ("foo" near (50, 60)) mustEqual (MongoFieldFilter("foo", $near, MongoPrimitiveJObject(JObject(List(JField("$near", JArray(List(JNum(50.0), JNum(60.0)))))))))
  }
  "builds $within for box" in {
    ("foo" within Box((10, 20), (30, 40))) mustEqual (MongoFieldFilter("foo", $within, MongoPrimitiveJObject(JObject(JField("$within", JObject(JField("$box", JArray(JArray(JNum(10.0) :: JNum(20.0) :: Nil) :: JArray(JNum(30.0) :: JNum(40.0) :: Nil) :: Nil)) :: Nil)) :: Nil))))
  }
  "builds $within for circe" in {
    ("foo" within Circle((10, 20), 30)) mustEqual (MongoFieldFilter("foo", $within, MongoPrimitiveJObject(JObject(JField("$within", JObject(JField("$center",  JArray(JArray(JNum(10.0) :: JNum(20.0) :: Nil) :: JNum(30.0) :: Nil)) :: Nil)) :: Nil))))
  }
  "builds $within for CenterSphere" in {
    ("foo" within CenterSphere((10, 20), 0.3)) mustEqual (MongoFieldFilter("foo", $within, MongoPrimitiveJObject(JObject(JField("$within", JObject(JField("$centerSphere",  JArray(JArray(JNum(10.0) :: JNum(20.0) :: Nil) :: JNum(0.3) :: Nil)) :: Nil)) :: Nil))))
  }
  "builds $within for polygon" in {
    ("foo" within Polygon((10, 20), (30, 40))) mustEqual (MongoFieldFilter("foo", $within, MongoPrimitiveJObject(JObject(JField("$within", JObject(JField("$polygon", JArray(JArray(JNum(10.0) :: JNum(20.0) :: Nil) :: JArray(JNum(30.0) :: JNum(40.0) :: Nil) :: Nil)) :: Nil)) :: Nil))))
  }
