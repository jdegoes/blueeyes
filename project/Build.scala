...
object BlueEyesBuild extends Build {
  ...
  val actorSettings = nexusSettings ++ Seq(libraryDependencies ++= scalaz.libDeps)
  lazy val actor = scalaz.addDeps(Project(id = "actor", base = file("actor")).settings(actorSettings : _*))
}
